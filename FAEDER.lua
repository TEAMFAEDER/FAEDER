...
if text == "لل" and faeder11(msg) then
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""), offset_ = 0,limit_ = 200},function(ta,faeder)
local t = "\n⛔┇ قائمة الاعضاء \n━━━━━━━━━━━━━\n"
x = 0
local list = faeder.members_
for k, v in pairs(list) do
x = x + 1
if faederdx1:get(FAEDER.."Save:UserName"..v.user_id_) then
t = t..""..x.." - {[@"..faederdx1:get(FAEDER.."Save:UserName"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
faederdx(msg.chat_id_,msg.id_,t)
end,nil)
end
